<div class="p-6">
    ...
    <div class="bg-gray-50 shadow rounded-lg p-6 border border-gray-200 mt-6 max-w-xl mx-auto">
        ...
        <div class="flex space-x-3">
            ...
            <a href="{{ route('download.template-csv') }}" target="_blank" download="Template_Import_ADAPTIKA.csv" class="bg-emerald-600 text-white px-4 py-2 rounded hover:bg-emerald-700 shadow font-semibold inline-flex items-center gap-1">
                📥 Format CSV
            </a>
        </div>
    </div>
